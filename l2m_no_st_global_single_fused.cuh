__global__
void __launch_bounds__(1024) l2m_no_st_global_single_fused(
  // 256x56x56x256
  ...
  if (((int)blockIdx.x < 224)) {
    if (((int)threadIdx.x < 1024)) {
    {
      ...
      for (int32_t kk_406 = 0; kk_406 < 896; kk_406 += 1) {
        var_15734[0] = (((relu_3__tmp_0[((1024 * (int)blockIdx.x) + ((229376 * kk_406) + (int)threadIdx.x))] > (float16)0.0000f))) * (elementwise_add_1____GRAD[((1024 * (int)blockIdx.x) + ((229376 * kk_406) + (int)threadIdx.x))] + relu_3__tmp_0____GRAD____RENAME____block0____1[((1024 * (int)blockIdx.x) + ((229376 * kk_406) + (int)threadIdx.x))]);
