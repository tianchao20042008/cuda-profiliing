...
__global__
void __launch_bounds__(1024) double_fused(
  // 256x56x56x256
  ...
  if (((int)blockIdx.x < 224)) {
    if (((int)threadIdx.x < 1024)) {
    {
      ...
      for (int32_t kk_406 = 0; kk_406 < 896; kk_406 += 1) {
        ...
        var_15937[0] = ((var_15742[((1024 * (int)blockIdx.x) + ((229376 * kk_406) + (int)threadIdx.x))] * ((float)(conv2d_56__tmp_0[((1024 * (int)blockIdx.x) + ((229376 * kk_406) + (int)threadIdx.x))]))) - (var_15742[((1024 * (int)blockIdx.x) + ((229376 * kk_406) + (int)threadIdx.x))] * batch_norm_3__tmp_0[((int)threadIdx.x & 255)]));
